...
def main(argv: list[str] | None = None) -> int:
    ...
    placeholder_inputs = {
        ...
        "build-charts": [getattr(args, "metrics_source", ""), getattr(args, "report_rules", "")],
        "assemble-report": [getattr(args, "chart_manifest", ""), getattr(args, "report_rules", "")],
        "write-report": [getattr(args, "artifact", "")],
